...
Pod::Spec.new do |s|
  s.name         = "DialogCreateSage"
  s.version      = "1.0.0"
  s.summary      = "iOS DialogCreateSage Module."
  s.author       = { "DialogCreateSage" => "DialogCreateSage.me" }
  s.homepage     = "DialogCreateSage"
  s.source       = { :git => "http://DialogCreateSage.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'DialogCreateSage/Classes/**/*'
  s.resources = "DialogCreateSage/Resources/*.bundle"
  s.vendored_libraries = 'DialogCreateSage/Classes/**/*.a'
