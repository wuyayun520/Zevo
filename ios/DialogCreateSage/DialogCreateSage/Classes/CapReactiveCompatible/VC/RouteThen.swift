...
class RouteThen: MergeContactViewController {
    ...
    lazy var topView: TreetopReactiveCompatible = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = TreetopReactiveCompatible(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: GobletShapedBottomView = {
    ...
    lazy var usePhotoView: OptView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = OptView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension RouteThen {
    ...
    func analysisModle(modle: LivingMomentModel) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==CompositionReactiveCompatible.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == CompositionReactiveCompatible.share.loginUserMode.sex
        }
