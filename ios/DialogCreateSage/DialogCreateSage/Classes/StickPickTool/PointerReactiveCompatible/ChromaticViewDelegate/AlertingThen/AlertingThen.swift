...
/*: "st_slider_thumb" :*/
fileprivate let noti_solutionArcText:String = "st_slguide acquire people"
fileprivate let mainDisagreeCapSlideMessage:String = "HUMB"

/*: "init(coder:) has not been implemented" :*/
fileprivate let show_dueAccessStr:[UInt8] = [0xfd,0x2,0xfd,0x8,0xbc,0xf7,0x3,0xf8,0xf9,0x6,0xce,0xbd,0xb4,0xfc,0xf5,0x7,0xb4,0x2,0x3,0x8,0xb4,0xf6,0xf9,0xf9,0x2,0xb4,0xfd,0x1,0x4,0x0,0xf9,0x1,0xf9,0x2,0x8,0xf9,0xf8]

fileprivate func bubbleMaterial(pow num: UInt8) -> UInt8 {
...
class AlertingThen: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.parentSet(name: (String(noti_solutionArcText.prefix(5)) + "ider_t" + mainDisagreeCapSlideMessage.lowercased()))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_dueAccessStr.map{bubbleMaterial(pow: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.processAcross(type: .Regular, fontSize: 12)
