...
//: @objcMembers public class HelpThen: JSONModel {
@objcMembers public class HelpThen: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = MidAdditiveArithmetic.Face
...
//: @objc extension HelpThen {
@objc extension HelpThen {
    //: func initWith(suiteType: BeautyItemType)-> HelpThen {
    func rooms(suiteType: MidAdditiveArithmetic) -> HelpThen {
        //: let model = HelpThen.init()
        let model = HelpThen()
