...
fileprivate let dataProximateMessage:[UInt8] = [0x91,0x96,0x91,0x8c,0xd0,0x9b,0x97,0x9c,0x9d,0x8a,0xc2,0xd1,0xd8,0x90,0x99,0x8b,0xd8,0x96,0x97,0x8c,0xd8,0x9a,0x9d,0x9d,0x96,0xd8,0x91,0x95,0x88,0x94,0x9d,0x95,0x9d,0x96,0x8c,0x9d,0x9c]

private func physicalEntire(firm num: UInt8) -> UInt8 {
    return num ^ 248
}
...
let dataStatusItemTitle = 3.0

//: class CircleCountdownView: UIView {
class TriumphThen: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.submaxilla() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataProximateMessage.map{physicalEntire(firm: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.processAcross(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: dataStatusItemTitle / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: dataStatusItemTitle / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - dataStatusItemTitle,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - dataStatusItemTitle)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.submaxilla().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = dataStatusItemTitle
...
extension TriumphThen {
    ...
    func gestureResume(totalTime: Int, currTime: Int) {
