...
class WordsSweetTitleView: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        buccalCavity(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        buccalCavity(placeholder: nil, placeholderColor: nil)
    }
}
...
extension WordsSweetTitleView {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func buccalCavity(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(BenchLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(BenchLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-BenchLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: MilitaryContainerInset().top, left: MilitaryContainerInset().left, bottom: MilitaryContainerInset().bottom, right: MilitaryContainerInset().right)
...
extension WordsSweetTitleView: UITextViewDelegate {
