...
enum AddressContiguousBytes: String {
    //: case AppleLogin
...
enum AdminTextSignedNumeric: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
enum RedDwarfFindComparable: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum RelevantSweetHashable: Int {
    //: case isOnGoing = 0
...
enum GenRestaurantSendable: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum ColumnExInsetTarget: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum AgainColumnConvertible: Int {
    //: case Unavailable = 0
...
enum FrankBlockCaseIterable: CaseIterable {
...
enum CompositionArrowPriorityTarget: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
