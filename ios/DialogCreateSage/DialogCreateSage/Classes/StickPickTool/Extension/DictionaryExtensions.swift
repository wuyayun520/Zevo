...
extension Dictionary {
    ...
    public static func chalkLine(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func progressModelOffer(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.chalkLine(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
