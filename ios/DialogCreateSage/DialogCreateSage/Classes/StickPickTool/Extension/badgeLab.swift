...
class CoronaBadgeLab: UILabel {
    ...
    //: private func setup() {
    private func receiptsSetup() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.spendColor().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.processAcross(type: .Medium, fontSize: 11)
...
class TensionPreviouslyAlignLb: UILabel {
