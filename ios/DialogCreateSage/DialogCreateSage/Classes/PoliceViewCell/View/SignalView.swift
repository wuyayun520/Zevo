...
fileprivate let appCancelKey:[UInt8] = [0x50,0x57,0x50,0x4d,0x11,0x5a,0x56,0x5d,0x5c,0x4b,0x3,0x10,0x19,0x51,0x58,0x4a,0x19,0x57,0x56,0x4d,0x19,0x5b,0x5c,0x5c,0x57,0x19,0x50,0x54,0x49,0x55,0x5c,0x54,0x5c,0x57,0x4d,0x5c,0x5d]

/*: "area_icon_ :*/
fileprivate let constLiteId:String = "successfully clickarea_i"

/*: "get img error" :*/
fileprivate let constGenreStr:String = "reminder coat provider noseget im"
...
class SignalView: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: appCancelKey.map{$0^57}, encoding: .utf8)!)
    }
...
extension SignalView {
    ...
    public func worldwide(areaModel: ToolTransformable) {
        ...
        if areaModel.url.isEmptyString {
            ...
            imageName = (String(constLiteId.suffix(6)) + "con_") + "\(imageName)@2x"
            //: do {
            do {
                ...
                printLog(message: (String(constGenreStr.suffix(6)) + "g error"))
            }
            //: }else {
        } else {
