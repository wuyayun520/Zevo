...
struct ExecMeasurable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: BroadChinMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [HypothesisModelType]? // 相册
    ...
    var aiExtraInfo = ExtraTransformable() // AI模型
    //: var vipSkinId = 0
...
struct BroadChinMeasurable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [EyeContactMeasurable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct EyeContactMeasurable: HandyJSON {
...
struct HypothesisModelType: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func sum(compareTo: HypothesisModelType) -> Bool {
        //: return
        return
...
struct ExtraTransformable: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum WarningValueConvertible: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
