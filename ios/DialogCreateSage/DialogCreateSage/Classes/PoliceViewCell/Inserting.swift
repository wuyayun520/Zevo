...
/*: "detection" :*/
fileprivate let dataFinancialId:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let kZzArmPath:String = "aifollowfollow"
...
class Inserting: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = Inserting()
    ...
    func foreRefuse() {
        ...
        let soundFilePath = AuthorReactiveCompatible.default.guideType(name: (String(dataFinancialId)), type: (kZzArmPath.replacingOccurrences(of: "follow", with: "f")))
