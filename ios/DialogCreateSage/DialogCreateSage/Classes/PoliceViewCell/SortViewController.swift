...
/*: "Face verification" :*/
fileprivate let appBirthRecentPath:String = "establish bigFace ver"
fileprivate let user_pairMsg:[Character] = ["i","f","i","c","a","t","i","o","n"]
...
class SortViewController: MergeContactViewController {
    ...
    override func viewDidLoad() {
        ...
        title = (String(appBirthRecentPath.suffix(8)) + String(user_pairMsg)).localized
        //: self.createUI()
        self.origin()
...
extension SortViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = NutlikeReactiveCompatible(photoImage: photo)
...
extension SortViewController {
    ...
    func origin() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            MeetRouteThen.funcPersonDomino(true) { isOpen in
