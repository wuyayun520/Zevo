...
fileprivate let app_sightMessage:[UInt8] = [0xe6,0xeb,0xe6,0xf1,0xa5,0xe0,0xec,0xe1,0xe2,0xef,0xb7,0xa6,0x9d,0xe5,0xde,0xf0,0x9d,0xeb,0xec,0xf1,0x9d,0xdf,0xe2,0xe2,0xeb,0x9d,0xe6,0xea,0xed,0xe9,0xe2,0xea,0xe2,0xeb,0xf1,0xe2,0xe1]

fileprivate func endGovern(skip num: UInt8) -> UInt8 {
...
class AgainMiniView: CastView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_sightMessage.map{endGovern(skip: $0)}, encoding: .utf8)!)
    }
...
extension AgainMiniView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func topNorth(liveUrl: String) {
...
extension AgainMiniView: TXLivePlayListener {
