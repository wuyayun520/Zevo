...
fileprivate let noti_strategicId:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let user_publicityContent:[Character] = ["i","c","o","n","_","l","i","v","e","t","c","_","w"]
fileprivate let mainJudgeValue:String = "arplayer"
...
class BenchThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_strategicId.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.parentSet(name: (String(user_publicityContent) + mainJudgeValue.replacingOccurrences(of: "player", with: "n")))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = CompositionReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        lab.text = CompositionReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(shirtButtonThin), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension BenchThen {
    ...
    @objc private func shirtButtonThin() {
        //: dismiss()
        moveFull()
    }
}
...
extension BenchThen {
    ...
    private func requestSwitchicial() {
