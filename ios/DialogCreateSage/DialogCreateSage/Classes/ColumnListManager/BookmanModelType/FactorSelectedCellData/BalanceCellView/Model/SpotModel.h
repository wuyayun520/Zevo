...
@property (nonatomic, strong)AboutModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)SaveModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)WakelessModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)AccelerateModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)StereoDogModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)RankModel *quoteMsgInfo;

//: @property (nonatomic, strong)ChinMeasurable *userInfoModel;
@property (nonatomic, strong)ChinMeasurable *userInfoModel;
...
@interface AboutModel : JSONModel
...
@property (nonatomic, strong) OnerModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) SubmitModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ChatModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) ScopeModel *wantGift; /// 想要礼物
...
+ (void)relieveFor:(OnerModel *)photoModel save:(NSString *)msgID;

//: + (NSMutableDictionary<NSString *, NSString *> *)loadLocalIntimatePhotoDict;
+ (NSMutableDictionary<NSString *, NSString *> *)draw;
...
@interface SubmitModel: JSONModel
...
+ (void)range:(SubmitModel *)videoModel salvageTargetUnwanted:(NSString *)msgID;

//: + (NSMutableDictionary<NSString *, NSString *> *)loadLocalIntimateVideoDict;
+ (NSMutableDictionary<NSString *, NSString *> *)suite;
...
@interface WakelessModel : JSONModel
...
@interface AccelerateModel : JSONModel
...
@interface StereoDogModel : JSONModel
...
@interface ScopeModel : JSONModel
...
+ (void)manager:(NSString *)msgID;

//: + (NSMutableArray *)loadAskForGiftArr;
+ (NSMutableArray *)withoutAcross;
...
@property (nonatomic, strong) PlaceModel *renderData;

//: - (BOOL)isQuoteMsg;
- (BOOL)iconography;

//: - (CGSize)quoteSize:(NSInteger)maxWidth;
- (CGSize)margin:(NSInteger)maxWidth;
