...
/*: "bg_chat_honey_left" :*/
fileprivate let k_pressKey:[Character] = ["b","g","_","c","h","a","t","_"]
fileprivate let data_recommendationName:[Character] = ["h","o","n","e","y","_","l","e","f","t"]

/*: "bg_chat_honey_right" :*/
fileprivate let kAgreePath:[Character] = ["b","g","_","c","h","a","t","_","h","o","n","e","y","_","r","i","g"]
fileprivate let dataPhonePublicityId:String = "extendedt"

/*: "init(coder:) has not been implemented" :*/
fileprivate let constDetectTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#FA74B7" :*/
fileprivate let const_absPath:String = "#FA74B7its total"

/*: "icon_coin" :*/
fileprivate let k_hideMessage:[Character] = ["i","c","o","n","_","c","o","i","n"]
...
//: @objcMembers public class FactorSelectedCellData: TalkingChatMsgBaseCellData {
@objcMembers public class FactorSelectedCellData: BlockCellData {
    ...
    override public init(direction: FindExpressionConvertible) {
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.bubbleImg = UIImage.imageCorner(name: (String(k_pressKey) + String(data_recommendationName)))
            ...
            self.bubbleImg = UIImage.imageCorner(name: (String(kAgreePath) + dataPhonePublicityId.replacingOccurrences(of: "extended", with: "h")))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constDetectTitle.reversed(), encoding: .utf8)!)
    }
    ...
    public lazy var attributedString: NSMutableAttributedString = {
        ...
        let attr = homeRead(giftModel: self.msgModel)
        //: return attr
        return attr
        //: }()
    }()
    ...
    func homeRead(giftModel: SpotModel) -> NSMutableAttributedString {
        ...
        let giftname = manual(giftmodel: giftModel.msgInfo.wantGift)
        ...
        let attr1 = NSMutableAttributedString(string: str, attributes: [.font: font, .foregroundColor: UIColor.antiquityColor()])
        //: let attr2 = NSMutableAttributedString.init(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor.init(hex: "#FA74B7")!])
        let attr2 = NSMutableAttributedString(string: "\(giftname)\n", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(const_absPath.prefix(7))))!])
        ...
        let attr3 = NSMutableAttributedString(string: "\(giftModel.msgInfo.wantGift.giftPrice)", attributes: [.font: font, .foregroundColor: UIColor(hex: (String(const_absPath.prefix(7))))!])
        ...
        giftImgV.pastEstimated(urlStr: giftModel.msgInfo.wantGift.giftIcon)
        ...
        giftImgV2.image = UIImage.parentSet(name: (String(k_hideMessage)))
    ...
    func manual(giftmodel: ScopeModel) -> String {
        ...
        if CosSweetReactiveCompatible.share.interfaceLang == ShadesOfTransformable.en.rawValue {
            ...
            gameName = giftmodel.giftNameI18n[ShadesOfTransformable.en.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ShadesOfTransformable.ar.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ShadesOfTransformable.es.rawValue] as? NSString ?? ""
            ...
            gameName = giftmodel.giftNameI18n[ShadesOfTransformable.pt.rawValue] as? NSString ?? ""
        }
