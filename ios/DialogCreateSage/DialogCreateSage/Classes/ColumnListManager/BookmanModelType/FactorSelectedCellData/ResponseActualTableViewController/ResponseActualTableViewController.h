 ...
 *
 *  HorizonHung 协议和 ResponseActualTableViewController 类。
 *  ResponseActualTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 ResponseActualTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class ResponseActualTableViewController;
//: @class ReaderView;
@class ReaderView;
//: @class TwoCellData;
@class TwoCellData;
...
- (void)rituals:(ResponseActualTableViewController *)controller;
...
- (void)beyondIdentity:(ResponseActualTableViewController *)controller;
...
- (BOOL)pass:(ResponseActualTableViewController *)controller brightEnable:(UIView *)view;
 ...
 */
//: - (TwoCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (TwoCellData *)controller:(ResponseActualTableViewController *)controller message:(V2TIMMessage *)data;
 ...
 */
//: - (ReaderView *)messageController:(TUIMessageController *)controller onShowMessageData:(TwoCellData *)data;
- (ReaderView *)cilium:(ResponseActualTableViewController *)controller origin:(TwoCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(ReaderView *)cell;
- (void)bean:(ResponseActualTableViewController *)controller avatar:(ReaderView *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(ReaderView *)cell;
- (void)breadth:(ResponseActualTableViewController *)controller incumbent:(ReaderView *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(TwoCellData *)data;
- (void)fill:(ResponseActualTableViewController *)controller smart:(NSInteger)menuType informationMessage:(TwoCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(ReaderView *)cell;
- (void)max:(ResponseActualTableViewController *)controller nearCur:(ReaderView *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(TwoCellData *)cellData;
- (void)historyRootMessage:(ResponseActualTableViewController *)controller roundMessage:(TwoCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(TwoCellData *)cellData;
- (void)method:(ResponseActualTableViewController *)controller last:(TwoCellData *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         ResponseActualTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】ResponseActualTableViewController
...
@interface ResponseActualTableViewController : UITableViewController

/**
 *  执行 HorizonHung 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<HorizonHung> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<TwoCellData *> *)uiMsgs;
