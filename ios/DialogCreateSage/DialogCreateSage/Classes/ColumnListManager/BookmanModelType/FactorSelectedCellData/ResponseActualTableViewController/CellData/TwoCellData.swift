...
@objc public enum ProposalColumnConvertible: UInt {
...
@objc public enum FindExpressionConvertible: UInt {
 ...
 */
//: @objcMembers public class TwoCellData: TCommonCellData {
@objcMembers public class TwoCellData: StrainThen {
    ...
    public var direction: FindExpressionConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: ProposalColumnConvertible = .MsgTranslate_init
    ...
    public var msgModel: SpotModel = SpotModel()
    ...
    public var cellLayout: CellOuterThen!
    ...
    public init(direction: FindExpressionConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.ground()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = CellOuterThen(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = CellOuterThen(isIncomming: false)
    ...
    public func secretoryPhase() -> CGSize {
        //: return CGSize.zero
        return CGSize.zero
    }
    ...
    public override func clubMargin(_ width: CGFloat) -> CGFloat {
