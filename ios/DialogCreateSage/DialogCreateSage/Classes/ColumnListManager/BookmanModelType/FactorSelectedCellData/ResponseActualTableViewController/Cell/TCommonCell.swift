...
@objcMembers public class StrainThen: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func clubMargin(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class FrankThen: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: StrainThen?
    ...
    @objc dynamic public func hitch(with data: StrainThen) {
        //: self.data = data
        self.data = data
    }
} 