...
open class PromiseScrollView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = PromiseScrollView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
