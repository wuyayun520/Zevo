...
class OverReactiveCompatible: NSObject {
...
extension OverReactiveCompatible {
    /// 释放资源
    ...
    func permissionCamera(_ frontCamera: Bool) {
        ...
        self.suitInside(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func cameraLens(_ openCamera: Bool) {
    ...
    func analysisView() {
        ...
        DispatchQueue.main.async {
            ...
            self.getDown(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension OverReactiveCompatible {
    ...
    private func suitInside(front: Bool) {
    ...
    private func resOld(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard notiNetPointName == true else {
            //: if isOpen {
            if isOpen {
...
extension OverReactiveCompatible {
    ...
    func contrastRemark() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(playerAdvertising(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(positiveAvailable(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(belowErr(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(auditor(notif:)),
    ...
    @objc private func playerAdvertising(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func positiveAvailable(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func belowErr(notif: Notification) {
    ...
    @objc func auditor(notif: Notification) {
