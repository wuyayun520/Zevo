...
fileprivate let mainChooseStarData:[UInt8] = [0x52,0x55,0x52,0x4f,0x13,0x58,0x54,0x5f,0x5e,0x49,0x1,0x12,0x1b,0x53,0x5a,0x48,0x1b,0x55,0x54,0x4f,0x1b,0x59,0x5e,0x5e,0x55,0x1b,0x52,0x56,0x4b,0x57,0x5e,0x56,0x5e,0x55,0x4f,0x5e,0x5f]

private func makeJoin(bird num: UInt8) -> UInt8 {
    return num ^ 59
}

/*: "JXBannerCellID" :*/
fileprivate let app_coordinatorMessage:String = "Jup"
fileprivate let data_analyzeMsg:String = "Bannerhoney shared violation military"
...
class MaximumViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainChooseStarData.map{makeJoin(bird: $0)}, encoding: .utf8)!)
    }
...
extension MaximumViewCell: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (app_coordinatorMessage.replacingOccurrences(of: "up", with: "X") + String(data_analyzeMsg.prefix(6)) + "CellID"))
    }
...
extension MaximumViewCell {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func regain(bannerData: [HostBannerModel]) {
...
extension MaximumViewCell {
    ...
    private func commercialEnterprise() {
