...
fileprivate let notiAbleUrl:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "img_match_shadow" :*/
fileprivate let appGiftUrl:String = "quality carryimg_matc"
fileprivate let k_noteUrl:String = "revenue multiple meet am somebodyh_shadow"

/*: "icon_match_topshowdown" :*/
fileprivate let mainOccupationData:String = "judge interesticon_m"
fileprivate let app_productText:String = "dismiss jaw_top"
fileprivate let constAssistantUrl:String = "agent"
fileprivate let data_stageUntilText:String = "hwarningdwarningn"

/*: "Matching..." :*/
fileprivate let show_helpMsg:String = "Matchregion session decide"
fileprivate let appCoordinateId:[Character] = ["."]

/*: "get json error" :*/
fileprivate let userEnhanceEnterpriseValue:String = "no invite raftget j"
fileprivate let showWhatSelectPriseKey:[Character] = ["r","r","o","r"]

/*: "img_home_shadow" :*/
fileprivate let main_pathTitle:[Character] = ["i","m","g","_","h","o","m","e","_","s","h"]
fileprivate let dataPhaseName:[Character] = ["a","d","o","w"]

/*: "icon_home_girl" :*/
fileprivate let dataConferenceUrl:[Character] = ["i","c","o","n","_","h","o","m","e","_","g","i","r","l"]
...
typealias TouchCallBlock = (_ model: RoundingModelType) -> Void

//: class TalkingClubCardItemCell: TalkingClubCardViewCell {
class CompartmentThen: ListenView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiAbleUrl.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var gradientShadowImageView: UIImageView = {
        ...
        imageView.image = UIImage.parentSet(name: (String(appGiftUrl.suffix(8)) + String(k_noteUrl.suffix(8))))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var topShowdImageView: UIImageView = {
        ...
        imageView.image = UIImage.parentSet(name: (String(mainOccupationData.suffix(6)) + "atch" + String(app_productText.suffix(4)) + constAssistantUrl.replacingOccurrences(of: "agent", with: "s") + data_stageUntilText.replacingOccurrences(of: "warning", with: "ow")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var sexBtn: UIButton = {
        ...
        btn.titleLabel?.font = .processAcross(type: .Medium, fontSize: 13)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var matchTipsLabel: UILabel = {
        ...
        label.text = (String(show_helpMsg.prefix(5)) + "ing.." + String(appCoordinateId)).localized
        //: label.isHidden = true
        label.isHidden = true
        //: return label
        return label
    ...
    private lazy var callBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(outsideSlideClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var callPlayer: SVGAPlayer = {
        ...
        let url = AuthorReactiveCompatible.default.typeTo(type: .Match_userCall)
        //: do {
        do {
            ...
            printLog(message: (String(userEnhanceEnterpriseValue.suffix(5)) + "son e" + String(showWhatSelectPriseKey)))
        }
        //: return player
        return player
        //: }()
...
extension CompartmentThen {
    ...
    func proposalOfLaunch(model: RoundingModelType) {
        //: self.model = model
        self.model = model
        ...
        if model.cover.count > 0 {
            ...
            userImageView.funReply(urlStr: model.cover, placeImg: UIImage.parentSet(name: (String(main_pathTitle) + String(dataPhaseName))))
            ...
            userImageView.funReply(urlStr: model.headPic, placeImg: UIImage.parentSet(name: (String(main_pathTitle) + String(dataPhaseName))))
            //: } else {
        } else {
            //: userImageView.image = UIImage.BundleImageNamed(name: "img_home_shadow")
            userImageView.image = UIImage.parentSet(name: (String(main_pathTitle) + String(dataPhaseName)))
        }
        //: userIconImg.setUrlImage(urlStr: model.headPic, placeImg: nil)
        userIconImg.agreeFinish(urlStr: model.headPic, placeImg: nil)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
        sexBtn.setBackgroundImage(UIImage.parentSet(name: (String(dataConferenceUrl))), for: .normal)
    ...
    @objc private func outsideSlideClick() {
