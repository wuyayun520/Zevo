...
/*: "&sr=6" :*/
fileprivate let userEarnId:String = "last gender exposure over&sr=6"
...
enum BarbBidirectionalCollection: String, CaseIterable {
...
class SceneManager: NSObject {
    ...
    class func dropWith(urlType: AlertEquatable) -> String {
        //: var url = CompositionReactiveCompatible.share.appConfigMode.urlH5Domain
        var url = CompositionReactiveCompatible.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(CompositionReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : CompositionReactiveCompatible.share.appUserConfigMode.fullRechargePage)
            url.append(CompositionReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : CompositionReactiveCompatible.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage)
            url.append(CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending((String(userEarnId.suffix(5))))
            //: url.append(CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(CompositionReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
