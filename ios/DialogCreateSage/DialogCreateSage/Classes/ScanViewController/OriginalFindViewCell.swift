...
fileprivate let noti_transportMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "area_icon_ :*/
fileprivate let main_damEachFormat:String = "layer lose bold pin thatarea_"

/*: "get img error" :*/
fileprivate let show_alreadyUrl:[Character] = ["g","e","t"," ","i","m","g"," ","e","r","r","o","r"]
...
class OriginalFindViewCell: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: noti_transportMsg.reversed(), encoding: .utf8)!)
    }
...
extension OriginalFindViewCell {
    //: public func func__updateUIWithModel(areaModel: TalkingAreaModel) {
    public func bit(areaModel: ToolTransformable) {
        ...
        if areaModel.url.isEmptyString {
            ...
            imageName = (String(main_damEachFormat.suffix(5)) + "icon_") + "\(imageName)@2x"
            //: do {
            do {
                ...
                areaImgView.image = UIImage.ground()
                //: printLog(message: "get img error")
                printLog(message: (String(show_alreadyUrl)))
            }
            //: }else {
        } else {
            //: areaImgView.setUrlImage(urlStr: areaModel.url)
            areaImgView.agreeFinish(urlStr: areaModel.url)
        }
    }
}
